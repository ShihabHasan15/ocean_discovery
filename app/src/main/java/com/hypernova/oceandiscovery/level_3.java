...
public class level_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View level_3_view = inflater.inflate(R.layout.fragment_level_3, container, false);

        lesson1 = level_3_view.findViewById(R.id.lesson1);
        lesson2 = level_3_view.findViewById(R.id.lesson2);
        lesson3 = level_3_view.findViewById(R.id.lesson3);
        ...
        lesson1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                learning_activity.learning_content = 7;
        ...
        lesson2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                learning_activity.learning_content = 8;
                startActivity(new Intent(getContext(), learning_activity.class));
            }
        });
        ...
        lesson3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                learning_activity.learning_content = 9;
                startActivity(new Intent(getContext(), learning_activity.class));
            }
        });
