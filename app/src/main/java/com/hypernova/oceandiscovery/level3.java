...
public class level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderItems.add(new SliderItem(R.drawable.chlorophyll_photo));
        sliderItems.add(new SliderItem(R.drawable.ocean_carbon_cycle));
        ...
        viewPager2.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (position==0) {
                    lesson_name.setText("Understanding Ocean Colors");
                    play_btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            startActivity(new Intent(level3.this, ocean_color.class));
                        }
                    });
                } else if (position==1) {
                    lesson_name.setText("Chlorophyll");
                    play_btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            startActivity(new Intent(level3.this, chlorophyll.class));
                        }
                    });
                }else if (position==2) {
                    lesson_name.setText("Ocean Carbon Cycle");
                    play_btn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            startActivity(new Intent(getApplicationContext(), carbon_cycle.class));
                        }
                    });
                } else if (position==3) {
